...
import { SessionEntityPg } from '../domain/session.entity.pg';

@Injectable()
export class SessionRepoPg {
  constructor(@InjectDataSource() private dataSource: DataSource) {}

  async add(dto: SessionEntityPg) {
  ...
  async update(sessionId: string, dto: Partial<SessionEntityPg>): Promise<boolean> {
